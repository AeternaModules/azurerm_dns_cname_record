output "dns_cname_records_id" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.id if v.id != null && length(v.id) > 0 }
}
output "dns_cname_records_fqdn" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.fqdn if v.fqdn != null && length(v.fqdn) > 0 }
}
output "dns_cname_records_name" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.name if v.name != null && length(v.name) > 0 }
}
output "dns_cname_records_record" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.record if v.record != null && length(v.record) > 0 }
}
output "dns_cname_records_resource_group_name" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "dns_cname_records_tags" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "dns_cname_records_target_resource_id" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.target_resource_id if v.target_resource_id != null && length(v.target_resource_id) > 0 }
}
output "dns_cname_records_ttl" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.ttl if v.ttl != null }
}
output "dns_cname_records_zone_name" {
  ...
  value       = { for k, v in azurerm_dns_cname_record.dns_cname_records : k => v.zone_name if v.zone_name != null && length(v.zone_name) > 0 }
}
